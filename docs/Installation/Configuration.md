...
| traceSuccessfulScenarios    | true/false                                                                | Determines whether SpecFlow should trace anything at all for successful scenario executions. Setting this to false means logs are buffered until an error has occurred in the scenario and discarded if one does not. <br/>**Default:** true                                                                                                  |
