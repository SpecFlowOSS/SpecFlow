...
We have set up a Discord channel for plugin developers [here](https://go.specflow.org/join-plugin-development-on-discord). If you questions regarding the development of plugins for SpecFlow, this is the place to ask them.