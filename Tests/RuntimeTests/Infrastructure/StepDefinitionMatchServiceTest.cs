...
namespace TechTalk.SpecFlow.RuntimeTests.Infrastructure
{
    ...
    public class StepDefinitionMatchServiceTest
    {
        ...
        {
            return new BindingMethod(new TestingBindingRuntime("dummy", "dummy"), name, new IBindingParameter[0], null);
        }

        private static BindingMethod CreateBindingMethodWithStrignParam(string name = "dummy")
        {
            return new BindingMethod(new TestingBindingRuntime("dummy", "dummy"), name, new IBindingParameter[] { new BindingParameter(new RuntimeBindingType(typeof(string)), "param1") }, null);
        }
