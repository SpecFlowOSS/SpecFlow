...
#line 11
 testRunner.And(string.Format("a hook \'FirstHook\' for \'{0}\' with order \'1000\'", eventType));
#line 12
 testRunner.And(string.Format("a hook \'ThirdHook\' for \'{0}\' with order \'3000\'", eventType));
#line 13
 testRunner.And(string.Format("a hook \'SecondHook\' for \'{0}\' with order \'2000\'", eventType));
#line 14
 testRunner.And(string.Format("a hook \'DefaultHook\' for \'{0}\'", eventType));
#line 15
 testRunner.And(string.Format("a hook \'FifthHook\' for \'{0}\' with order \'10001\'", eventType));
#line 16
