...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Calling Steps from StepDefinitions", "\tIn order to create steps of a higher abstraction\r\n\tAs a developer\r\n\tI want reuse" +
                    " other steps in my step definitions", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Other step definition can be called when derive from Steps base class: Given")]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Other step definition can be called when derive from Steps base class: When")]
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Other step definition can be called when derive from Steps base class: Then")]
