...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Using custom XSLT template for reports", "\tIn order to customize the look of the specflow reports\r\n\tAs a test manager\r\n\tI w" +
                    "ant to be able to specify a custom XSLT template for the report generation", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 9
 testRunner.And("there are NUnit test execution results for the project", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
        }
...
#line 12
 testRunner.Given("there is an XSLT template containing", @"  <xsl:template match=""/"">
  ...
  </xsl:template>	", ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 23
 testRunner.When("I generate SpecFlow NUnit execution report with the custom XSLT", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 24
 testRunner.Then("a report generated like", "\tfeatures: 2\r\n\tall: 5\r\n\tsuccess: 2\r\n\tfailure: 1\r\n\tpending: 1\r\n\tignored: 1", ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
