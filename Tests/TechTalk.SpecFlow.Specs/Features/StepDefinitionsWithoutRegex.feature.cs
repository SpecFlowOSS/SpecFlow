...
#line 22
 testRunner.And("the following step definitions", "[When]\npublic void When_WHO_does_something(string who)\n{\n\tif (who != \"Joe\") throw" +
                    " new Exception(\"invalid parameter: \" + who);\n}", ((TechTalk.SpecFlow.Table)(null)));
#line 30
 testRunner.When("I execute the tests");
#line 31
...
#line hidden
#line 187
 testRunner.And("the specflow configuration is", "<specFlow>\n<!-- the localized prefixes are detected if the \nfeature language or t" +
                    "he binding culture is set in the config -->\n<language feature=\"de-DE\" /> \n<!--<b" +
                    "indingCulture name=\"de-DE\" />-->\n</specFlow>", ((TechTalk.SpecFlow.Table)(null)));
#line 196
 testRunner.When("I execute the tests");
#line 197
