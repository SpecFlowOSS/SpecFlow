...
namespace TechTalk.SpecFlow.Specs.Drivers
{
    public class MsTestTestExecutionDriver
    {
        ...
        {
            string vsFolder = Environment.Is64BitProcess ? @"%ProgramFiles(x86)%\Microsoft Visual Studio 12.0\Common7\IDE" : @"%ProgramFiles%\Microsoft Visual Studio 10.0\Common7\IDE";
