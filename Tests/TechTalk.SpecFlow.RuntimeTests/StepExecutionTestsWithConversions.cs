...
namespace TechTalk.SpecFlow.RuntimeTests
{
    internal static class LegacyStepArgumentTypeConverterExtensions
    {
        ...
        public static Expression<Func<IStepArgumentTypeConverter, Task<object>>> GetConvertMethodFilter(object argument, Type type)
        {
    ...
    public class StepExecutionTestsWithConversions : StepExecutionTestsBase
    {
        ...
        public async Task ShouldCallTheOnlyThatCanConvertWithTable()
        {
            ...
            StepArgumentTypeConverterStub.Setup(LegacyStepArgumentTypeConverterExtensions.GetConvertMethodFilter(table, typeof(Table))).ReturnsAsync(table);
            StepArgumentTypeConverterStub.Setup(LegacyStepArgumentTypeConverterExtensions.GetConvertMethodFilter("argument", typeof(double))).ReturnsAsync(1.23);
