    ...
    public class CultureInfoScopeTests
    {
        ...
        private static FeatureContext GetFeatureContext(CultureInfo cultureInfo)
        {
            return new FeatureContext(default,
                                      ...
                                      new SpecFlowConfiguration(default, default, default, default, cultureInfo, default, default, default, default, default, default, default, default, default, default, default, default, default, default));
        }
    }
}
