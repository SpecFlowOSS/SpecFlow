...
namespace TechTalk.SpecFlow.FeatureTests.ScopedSteps
{
    ...
    public class ScopedStepsBindings
    {
        ...
        [Scope(Feature = "Scoping step definitions")] 
        ...
        [Scope(Scenario = "Scoping step definitions to scenarios")] 
        ...
        [Scope(Tag = "mytag", Feature = "Scoping step definitions")]
        ...
        [Given(@"I have a step definition that is scoped to tag (?:.*)")]
        [Scope(Tag = "mytag", Scenario = "More scope matches have higher precedency")]
