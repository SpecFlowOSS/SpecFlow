...
namespace SpecFlow.Tools.MsBuild.Generation
{
    public class GenerateFeatureFileCodeBehindTask : Task
    {
        ...
        public override bool Execute()
        {
            ...
            Log.LogMessage(MessageImportance.High, $"[SpecFlow] FeatureFiles from BuildTask: {string.Join(", ", featureFiles)}");
            ...
            Log.LogMessage(MessageImportance.High, $"[SpecFlow] ProjectInfo: {generateFeatureFileCodeBehindTaskInfo.ToString()}");
