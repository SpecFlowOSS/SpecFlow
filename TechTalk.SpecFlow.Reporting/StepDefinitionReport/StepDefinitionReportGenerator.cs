        ...
        private void CreateSampleStep(StepDefinition stepDefinition)
        {
            ...
            switch (stepDefinition.Type)
            {
                ...
                case "Then":
                    ...
                    break;
                case "StepDefinition":
                    stepDefinition.ScenarioStep = new ReportStep(SpecFlowLocation.Empty, "StepDefinition", sampleText, null, StepKeyword.StepDefinition, Parser.ScenarioBlock.StepDefinition);
                    break;
                default:
