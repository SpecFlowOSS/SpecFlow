...
//        {
//            var requestArgs = new[] { new Argument(BuildProtocolConstants.ArgumentId.Shutdown, argumentIndex: 0, key:"", value: "") };
//            return new BuildRequest(requestArgs);
//        }
...
//            if (length > 0x100000) //todo could happen
//            {
...
//                string key = BuildProtocolConstants.ReadLengthPrefixedString(reader);
//                string value = BuildProtocolConstants.ReadLengthPrefixedString(reader);
//                return new Argument(argId, argIndex, key, value);
//            }
...
//                BuildProtocolConstants.WriteLengthPrefixedString(writer, Key);
